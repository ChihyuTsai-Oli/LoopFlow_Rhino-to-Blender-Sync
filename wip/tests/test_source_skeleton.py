...
class SourceSkeletonTests(unittest.TestCase):
    ...
    def test_addon_bl_info_without_importing_bpy(self):
        ...
        self.assertEqual(bl_info["version"], (0, 0, 11))
    ...
    def test_addon_registers_expected_stub_idnames(self):
        ...
        self.assertIn("self.filepath", text)
        self.assertIn("DIR_PATH", text)
        self.assertIn("resolve_models_dir_from_work_folder", text)
