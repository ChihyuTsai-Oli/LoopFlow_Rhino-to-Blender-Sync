...
from foundation.paths import camera_path, light_path, log_path, model_path, objects_path
...
def build_health_report(
    *,
    ...
    lines = [
        ...
        "Objects: {}  {}".format("models/R2B_Objects.3dm", file_stamp(objects_path(root))),
