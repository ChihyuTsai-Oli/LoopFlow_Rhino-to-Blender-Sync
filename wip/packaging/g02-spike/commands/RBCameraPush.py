#! python 3
# -*- coding: utf-8 -*-
"""Yak 指令 RBCameraPush。開發入口仍是 entrypoints/RBCameraPush.py。"""
...
def _run():
    ...
    try:
        ...
        if templates is None or not any(templates.glob("*.zip")):
            import rhinoscriptsyntax as rs  # type: ignore

            rs.MessageBox(
                "Could not copy LoopFlow files to Documents\\\\LoopFlow\\\\Rhino to Blender Sync.\\n\\n"
                "Use the Package Manager toolbar (! _RBOpen / ! _RBModels / …), "
